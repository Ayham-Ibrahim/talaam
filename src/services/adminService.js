...
export const adminService = {
  ...
  async addTeacherExperience(id, { title, company, period, location, description }) {
    if (config.useMocks) {
      await mockDelay(300);
  ...
  async updateTeacherExperience(experienceId, { title, company, period, location, description }) {
    if (config.useMocks) {
      await mockDelay(300);
