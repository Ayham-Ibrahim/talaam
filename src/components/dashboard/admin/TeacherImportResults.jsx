...
export function TeacherImportResults({ result }) {
  const t = useT();
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center gap-3 rounded-2xl border border-[#F2F2F7] bg-white p-4 shadow-card">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-ink-soft">{t('dashboard.adminTeacherImport.importedLabel')}</div>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-2xl border border-[#F2F2F7] bg-white p-4 shadow-card">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-ink-soft">{t('dashboard.adminTeacherImport.failedLabel')}</div>
          </div>
        </div>
      </div>
          ...
          <table className="w-full min-w-[420px] text-sm">
            <thead>
              <tr className="border-b border-line">
                <th className="px-4 py-3 text-right font-bold text-ink">{t('dashboard.adminTeacherImport.colRow')}</th>
                <th className="px-4 py-3 text-right font-bold text-ink">{t('dashboard.adminTeacherImport.colError')}</th>
              </tr>
            </thead>
